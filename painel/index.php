<?php 
	...
	$query = mysqli_query($conn,"SELECT `id`, `login`, `senha`, `email`, `nome`, `sobrenome`, `rg`, `cpf`, `nascimento`, `rua`, `numero`, `cep`, `bairro`, `cidade`, `estado`, `plano` FROM `usuario` WHERE login='$login' AND senha='$senha'");
