<?php 
	...
	$query = mysqli_query($conn,"SELECT `id`, `login`, `senha`, `email`, `nome`, `sobrenome`, `rg`, `cpf`, DATE_FORMAT(`nascimento`,'%d/%m/%Y') AS `nascimento`, `rua`, `numero`, `cep`, `bairro`, `cidade`, `estado` FROM `usuario` WHERE login='$login' AND senha='$senha'");
