...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="MOD.html"><b>HOME</b></a>
      <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item" id="p-5 gradient-overlay bg-dark">
            <a class="nav-link" href="planos.html"><b class="text-light">PLANOS</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="somos.html"><b class="text-light">QUEM SOMOS</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="login.html"><b class="text-light">LOGIN</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="#"><b>CADASTRO</b></a>
          </li>
        </ul>
      </div>
    </div>
  </nav>
  <div class="py-5 text-white opaque-overlay" style="background-image: url(&quot;imagens/aaas.jpg&quot;);">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="col-md-12">
            ...
            <form class="" method="post" action="https://formspree.io/">
              <div class="form-group" for="inputUsuario"> <label>Usuário</label>
                <input type="usuario" id="inputUsuario" name="inputUsuario" class="form-control" placeholder="Digitar o Usuário" required autofocus>
                 </div>
              <div class="form-group"> <label>Senha</label>
                <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Digite a Senha" required>
                 </div>
        ...
        <div class="col-md-7">
          ...
          <p class="lead mb-4"> Faça agora mesmo o seu cadastro, é simples e rápido!</p>
            <form class="" method="post" action="https://formspree.io/">
              <div class="form-group"> <label>Endereço de e-mail</label>
                <input type="email" name="email" class="form-control" placeholder="Digite e-mail"> </div>
              <div class="form-group"> <label>Password</label>
                <input type="password" name="password" class="form-control" placeholder="Digite a Senha"> </div>
      ...
      <div class="row">
        ...
        <div class="p-4 col-md-3">
          ...
          <ul class="list-unstyled">
            <a href="MOD.html" class="text-white">Home</a>
            <br>
            <a href="planos.html" class="text-white">Planos</a>
            <br>
            <a href="somos.html" class="text-white">Quem Somos</a>
            <br>
